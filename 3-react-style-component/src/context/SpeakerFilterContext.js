...
function SpeakerFilterProvider({children, startingShowSession = false, startingEventYear="2019"}) {
    const { showSessions, setShowSessions,
            eventYear, setEventYear,
            searchQuery, setSearchQuery,
            EVENT_YEARS } = useSpeakerFilter(startingShowSession, startingEventYear);
